  ...
  return (
    ...
    >
      <div className="container flex h-14 items-center max-lg:px-5">
        <Link href="#hero" passHref className="lg:hidden flex-1 cursor-pointer z-2">
            <Image
              src="/images/xora.svg"
              width={115}
              height={55}
          ...
          <div className="max-lg:relative max-lg:flex max-lg:flex-col max-lg:min-h-screen max-lg:p-6 max-lg:overflow-hidden sidebar-before max-md:px-4">
            <nav className="max-lg:relative max-lg:z-2 max-lg:my-auto">
              <ul className="flex max-lg:block max-lg:px-12">
                <li className="nav-li">
                  <NavLink title="features" onClick={scrollToSection} />
                  <div className="dot" />
                  <NavLink title="pricing" onClick={scrollToSection} />
                </li>
                ...
                <li className="nav-li">
                  <NavLink title="faq" onClick={scrollToSection} />
                  <div className="dot" />
                  <NavLink title="download" onClick={scrollToSection} />
                </li>
              </ul>
            </nav>
